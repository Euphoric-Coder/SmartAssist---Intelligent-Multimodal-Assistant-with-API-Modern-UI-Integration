"""
Taken and modified this code for my purpose from Google Python Quickstart Guide about Google Calendar API
...
def main():
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            flow = InstalledAppFlow.from_client_secrets_file("GOOGLE_API.json", SCOPES)
    ...
    try:
        ...
        for event in events:
            ...
            print("The Google Meet Link: " + meet)
