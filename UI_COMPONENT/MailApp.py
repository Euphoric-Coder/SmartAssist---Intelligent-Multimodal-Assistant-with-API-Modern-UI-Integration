...
class LinkInsertionDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.open_link_previewer_button = QPushButton("Open Link Previewer")
        self.open_link_previewer_button.clicked.connect(self.open_link_previewer)
        ...
        layout.addWidget(self.open_link_previewer_button)

    def open_link_previewer(self):
        self.link_previewer = LinkPreviewer(self)
        self.link_previewer.exec()
...
class MingleComposer(QDialog):
    ...
    def keyPressEvent(self, event):
        if event.key() == Qt.Key.Key_Enter or event.key() == Qt.Key.Key_Return or event.key() == Qt.Key.Key_Return:
